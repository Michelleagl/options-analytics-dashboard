"""Panel 4 — Calibration detail and day-over-day stability check.
...
page documents the two-stage optimiser already in use, flags the Feller condition, and
lets you build up a local history of calibrations to compare over time -- see the
